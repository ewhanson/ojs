...
class DOIManagementHandler extends Handler {
	const ENABLE_ISSUE_DOI = 'enableIssueDoi';
	const ENABLE_PUBLICATION_DOI = 'enablePublicationDoi';
	const ENABLE_REPRESENTATION_DOI = 'enableRepresentationDoi';
...
//		PluginRegistry::loadPlugin("importexport", "crossref");
	 ...
	 * @return bool
	 */
	function _getCrossrefPluginStatus() {
